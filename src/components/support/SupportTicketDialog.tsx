...
import { useUserCommunication, SupportType } from '@/hooks/useUserCommunication';
...
const formSchema = z.object({
  ...
  supportType: z.enum(['Bug Report', 'Feature Request', 'Account Issue', 'Billing Question', 'Technical Help', 'Other']),
...
export function SupportTicketDialog({ open, onOpenChange }: SupportTicketDialogProps) {
  ...
  const onSubmit = async (values: FormValues) => {
    try {
      // Handle "none" value from select - convert to null
      const brandKitId = values.brandKitId && values.brandKitId !== 'none' ? values.brandKitId : null;
      
      await createCommunication.mutateAsync({
        communicationType: 'Support Ticket',
        brandKitId,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle>File a Support Ticket</DialogTitle>
          <DialogDescription>
